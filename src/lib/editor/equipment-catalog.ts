...
const temp = (min = -50, max = 100, critical = 110) =>
  p("temperature", "Temperatura", "°C", min, max, critical);
...
export const EQUIPMENT_CATALOG: CatalogCategory[] = [
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      {
        type: "tank",
        subtype: "mixing_tank_heated",
        idPrefix: "MX",
        label: "Issiq smes qozon",
        icon: "cylinder",
        defaultColor: "#e17055",
        defaultScale: 1,
      ...
      {
        type: "pump",
        subtype: "dosing_system",
        idPrefix: "DS",
        label: "Dozalash tizimi",
        icon: "gauge",
        defaultColor: "#00cec9",
        defaultScale: 0.6,
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "pasteurizer_plate",
        idPrefix: "PS",
        label: "Pasterizator (plastinkali)",
        icon: "thermometer",
        defaultColor: "#e17055",
        defaultScale: 0.9,
        defaultParams: [
      ...
      {
        type: "tank",
        subtype: "pasteurizer_batch",
        idPrefix: "PS",
        label: "Pasterizator (vannali)",
        icon: "thermometer",
        defaultColor: "#d63031",
        defaultScale: 0.9,
      ...
      {
        type: "line",
        subtype: "plate_cooler",
        idPrefix: "CL",
        label: "Sovutgich (plastinkali)",
        icon: "snowflake",
        defaultColor: "#0984e3",
        defaultScale: 0.7,
        defaultParams: [
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "continuous_freezer",
        idPrefix: "CF",
        label: "Continuous Freezer",
        icon: "snowflake",
        defaultColor: "#00b894",
        defaultScale: 1,
        defaultParams: [
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "extrusion_line",
        idPrefix: "EX",
        label: "Ekstruziya liniyasi",
        icon: "arrow-right",
        defaultColor: "#2ed573",
        defaultScale: 1,
      ...
      {
        type: "line",
        subtype: "filling_machine",
        idPrefix: "FL",
        label: "To'ldirish mashinasi",
        icon: "cup-soda",
        defaultColor: "#2ed573",
        defaultScale: 0.8,
      ...
      {
        type: "line",
        subtype: "stick_bar_line",
        idPrefix: "SK",
        label: "Stikli liniyasi",
        icon: "popsicle",
        defaultColor: "#fdcb6e",
        defaultScale: 1,
      ...
      {
        type: "line",
        subtype: "sandwich_line",
        idPrefix: "SB",
        label: "Sendvich liniyasi",
        icon: "sandwich",
        defaultColor: "#e17055",
        defaultScale: 1,
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "hardening_tunnel",
        idPrefix: "HT",
        label: "Hardening tunnel",
        icon: "wind",
        defaultColor: "#636e72",
        defaultScale: 1.2,
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "packaging_machine",
        idPrefix: "PK",
        label: "Qadoqlash mashinasi",
        icon: "package",
        defaultColor: "#a55eea",
        defaultScale: 0.8,
      ...
      {
        type: "line",
        subtype: "date_printer",
        idPrefix: "DT",
        label: "Sana bosish (Ink-jet)",
        icon: "printer",
        defaultColor: "#a55eea",
        defaultScale: 0.4,
      ...
      {
        type: "line",
        subtype: "check_weigher",
        idPrefix: "WG",
        label: "Tortish nazorati",
        icon: "scale",
        defaultColor: "#ff7675",
        defaultScale: 0.5,
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      ...
      {
        type: "warehouse",
        subtype: "semi_warehouse",
        idPrefix: "WH",
        label: "Yarim tayyor sklad",
        icon: "warehouse",
        defaultColor: "#a4b0be",
        defaultScale: 0.9,
      ...
      {
        type: "warehouse",
        subtype: "raw_warehouse",
        idPrefix: "WH",
        label: "Xom ashyo sklad",
        icon: "warehouse",
        defaultColor: "#c49b66",
        defaultScale: 1.3,
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "pump",
        subtype: "pump_centrifugal",
        idPrefix: "PM",
        label: "Nasos (markazdan qochma)",
        icon: "fan",
        defaultColor: "#ff9f43",
        defaultScale: 0.6,
      ...
      {
        type: "pump",
        subtype: "pump_peristaltic",
        idPrefix: "PM",
        label: "Nasos (peristaltik)",
        icon: "fan",
        defaultColor: "#ff9f43",
        defaultScale: 0.5,
      ...
      },
      {
        ...
        defaultParams: [
          pressure_bar(10),
          temp(100, 180, 200),
          p("water_level", "Suv sathi", "%", 0, 100, 95),
        ],
      },
      {
        type: "line",
  ...
  // ────────────────────────────────────────────────────────────
  {
    ...
    items: [
      {
        type: "line",
        subtype: "belt_conveyor",
        idPrefix: "CV",
        label: "Tasma konveyer",
        icon: "arrow-right",
        defaultColor: "#636e72",
        defaultScale: 1,
      ...
      {
        type: "line",
        subtype: "roller_conveyor",
        idPrefix: "CV",
        label: "Rolikli konveyer",
        icon: "arrow-right",
        defaultColor: "#636e72",
        defaultScale: 0.9,
      ...
      {
        type: "line",
        subtype: "spiral_conveyor",
        idPrefix: "CV",
        label: "Spiral konveyer",
      ...
      {
        type: "line",
        subtype: "sanitary_pipe",
        idPrefix: "PP",
        label: "Sanitarli quvur",
        icon: "git-branch",
        defaultColor: "#dfe6e9",
        defaultScale: 0.3,
