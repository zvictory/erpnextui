export const queryKeys = {
  ...
  accounts: {
    ...
    assetsWithCurrency: (company: string) => ["accounts", "assetsWithCurrency", company] as const,
  },
  journalEntries: {
  ...
  costing: {
    ...
    tabelSummaries: (woNames: string[]) => ["costing", "tabelSummaries", ...woNames] as const,
    laborReport: (from: string, to: string, company: string) =>
      ["costing", "laborReport", from, to, company] as const,
    laborAccrual: (workOrder: string, date: string) =>
      ["costing", "laborAccrual", workOrder, date] as const,
  },
  workOrderAssets: {
    byWo: (workOrder: string) => ["workOrderAssets", workOrder] as const,
    allAssets: (search: string) => ["workOrderAssets", "allAssets", search] as const,
  },
};
