...
export default function WarehousePipelinePage() {
  ...
  return (
    <div className="space-y-6">
      <h1 className="text-2xl font-semibold tracking-tight">{t("warehouseWorkflow")}</h1>
                ...
                >
                  ...
                  <CardContent className="flex flex-col items-start gap-1">
                    <div className="flex w-full items-center justify-between">
                      ...
                      <Icon className={cn("h-4 w-4 shrink-0", stage.textColor)} />
                    </div>
                    <span className={cn("text-3xl font-bold tabular-nums", stage.textColor)}>
                      {count}
                    </span>
