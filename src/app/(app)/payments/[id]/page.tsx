  ...
  return (
    <FormPageLayout title={pe.name} backHref="/payments">
      <div className="space-y-6">
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <Field
            label={t("paidAmount")}
            value={(() => {
              const cur = pe.payment_type === "Receive"
          ...
          {pe.mode_of_payment && (
            <Field label={t("modeOfPayment")} value={pe.mode_of_payment} />
          )}
          {pe.reference_no && (
            <Field label={t("referenceNo")} value={pe.reference_no} />
          )}
        </div>
      ...
      <ConfirmDialog
        ...
        loading={submitMutation.isPending || cancelMutation.isPending || deleteMutation.isPending}
      />
    </FormPageLayout>
  );
}
