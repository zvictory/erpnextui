...
import { useUnpaidSalesInvoices } from "@/lib/api/partners";

interface SalesTabProps {
  customerId: string;
}

export function SalesTab({ customerId }: SalesTabProps) {
  const t = useTranslations("partners");
  const { data: invoices, isLoading } = useUnpaidSalesInvoices(customerId);
